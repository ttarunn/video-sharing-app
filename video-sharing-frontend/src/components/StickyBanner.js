...
const StickyBanner = ({ postData }) => {
  const { title, date, duration, views, thumbnail, username, userImg } =
    postData;
  return (
    <div className="sticky-banner">
      <img src={thumbnail} className="sticky-banner-img" alt="banner" />
      <div className="sticky-banner-details">
        ...
        <img src={userImg} className="sticky-pub-img" alt="pub-img" />
